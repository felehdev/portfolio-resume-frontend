const Resume = () => {
  return (
    <article id="resume" className="resume section">
          ...
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div>
              ...
              <div className="resume-item">
                ...
                <h5>2007 – 2008</h5>
                <p>
                  <em>Faculty of Sciences, Sfax</em>
                </p>
                <p>Major: Foundation Courses (First Year)</p>
              </div>
              <div className="resume-item">
                <h4>Tunisian baccalaureate diploma</h4>
                <h5>2006</h5>
                <p>
                  <em>Technical High School, Zaghouan</em>
                </p>
                <p>Major: Technical - Sciences</p>
              </div>
            </div>
            <div className="mt-5">
