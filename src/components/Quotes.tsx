              ...
              <div className="quote-item">
                <div className="row gy-4 justify-content-center">
                  ...
                  <div className="col-lg-2 text-center">
                    <img
                      src="assets/img/quotes/socrates.jpg"
            ...
            <div className="swiper-slide">
              <div className="quote-item">
                <div className="row gy-4 justify-content-center">
                  ...
                  <div className="col-lg-2 text-center">
                    <img
                      src="assets/img/quotes/gandhi.jpg"
                      className="img-fluid quote-img"
                      alt=""
                    />
                  </div>
            ...
            <div className="swiper-slide">
              <div className="quote-item">
                <div className="row gy-4 justify-content-center">
                  ...
                  <div className="col-lg-2 text-center">
                    <img
                      src="assets/img/quotes/aristotle.jpg"
                      className="img-fluid quote-img"
                      alt=""
                    />
                  </div>
            ...
            <div className="swiper-slide">
              <div className="quote-item">
                <div className="row gy-4 justify-content-center">
                  ...
                  <div className="col-lg-2 text-center">
                    <img
                      src="assets/img/quotes/churchil.jpg"
                      className="img-fluid quote-img"
                      alt=""
                    />
                  </div>
            ...
            <div className="swiper-slide">
              <div className="quote-item">
                <div className="row gy-4 justify-content-center">
                  ...
                  <div className="col-lg-2 text-center">
                    <img
                      src="assets/img/quotes/steve.jpg"
                      className="img-fluid quote-img"
                      alt=""
                    />
                  </div>
            ...
            <div className="swiper-slide">
              <div className="quote-item">
                <div className="row gy-4 justify-content-center">
                  ...
                  <div className="col-lg-2 text-center">
                    <img
                      src="assets/img/quotes/nelson.jpg"
                      className="img-fluid quote-img"
                      alt=""
                    />
                  </div>
